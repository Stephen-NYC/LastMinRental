...
class GearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post gears_url, params: { gear: { brand: @gear.brand, category: @gear.category, item_name: @gear.item_name } }
    end
  ...
  test "should update gear" do
    patch gear_url(@gear), params: { gear: { brand: @gear.brand, category: @gear.category, item_name: @gear.item_name } }
